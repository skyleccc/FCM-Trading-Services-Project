...
$clientProjQuery = "SELECT projectID, projectName, projectType, DATE_FORMAT(completionDate, '%M %d, %Y') AS completionDate, isComplete FROM project, client WHERE client.clientID = project.clientID AND client.clientID = $clientID ORDER BY isComplete ASC, CASE WHEN isComplete = 1 THEN completionDate END DESC;";
